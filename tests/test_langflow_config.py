...
def test_docker_compose_passes_llm_settings_to_langflow_and_gateway():
    ...
    assert "BOI_AGENT_STATUS_LLM_ENABLED: ${BOI_AGENT_STATUS_LLM_ENABLED:-${BOI_AGENT_ROUTER_LLM_ENABLED:-auto}}" in compose_text
    assert "BOI_AGENT_STATUS_REQUIRED: ${BOI_AGENT_STATUS_REQUIRED:-1}" in compose_text
    assert "BOI_AGENT_STATUS_BASE_URL: ${BOI_AGENT_STATUS_BASE_URL:-${BOI_AGENT_ROUTER_BASE_URL:-http://llm-gateway.example:1236/v1}}" in compose_text
