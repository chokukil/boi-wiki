...
agent는 `boi-wiki-mcp`로 shared SOP, Event Type, Action Spec, Workflow Status를 검색한다. 그래도 Local Private 원문 전송과 Team/Public promotion submit은 사용자 명시 승인 없이는 금지된다.
