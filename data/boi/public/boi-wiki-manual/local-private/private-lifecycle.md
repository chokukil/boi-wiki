...
Local archive 경로는 `data/boi/private/{7자리사번}/_archive/YYYY/MM/`이다. `0000000`은 scaffold 전용이며 실제 개인 archive 경로로 쓰지 않는다. Web Private archive 경로는 `data/boi/private/{employee}/_archive/YYYY/MM/`이다. PoC v1은 hard delete보다 archive를 우선한다.
