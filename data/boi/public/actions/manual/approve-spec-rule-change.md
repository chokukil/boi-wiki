...
- HighRisk
- EquipmentWorkflow
timestamp: 2026-06-17 12:20:00+09:00
...
protocol: manual
method: HUMAN
url: manual://manual.equipment.approve_spec_rule_change
auth:
  type: human_handoff
  approval_required: true
headers:
...
curl: 'curl -X POST http://localhost:8100/api/actions/invoke -H ''x-service-token:
  $SERVICE_TOKEN'' -H ''Content-Type: application/json'' -d ''{"action_key":"manual.equipment.approve_spec_rule_change","payload":{"equipment_id":"ETCH-VM-01"}}'''
