...
type: boi/event-type
title: 단면검사 의뢰 및 결과 확인 요청
description: 단면검사가 필요하다고 판단되어 단면 검사 시스템 의뢰와 결과 확인이 필요한 시점
tags:
- EventType
- DirectDevelopment
- SOP
...
boi_id: boi:public:event-types:direct_development.cross_section.requested.v1
visibility: public
...
sop_stage_id: cross_section_execution
workflow_stage: 단면검사 의뢰/결과 확인
recommended_actions:
...
`direct_development.cross_section.requested.v1`는 [직개발 결과 확인 및 Reporting SOP](/public/sop/direct-development-reporting.md)의 `cross_section_execution` stage를 실행하거나 사람이 판단해야 할 지점을 기록한다.

# Recommended Actions

- [단면검사 의뢰 시뮬레이션](/public/actions/langflow/direct-development-cross-section-request-simulate.md)
- [단면검사 결과 확인 시뮬레이션](/public/actions/langflow/direct-development-cross-section-result-simulate.md)
- [연구소-양산 FAB 비교 이벤트 발행](/public/actions/event-broker/direct-development-create-fab-compare-event.md)
