...
type: boi/event-type
title: 직개발 결과 확인 요청
description: 직개발 결과에 대해 Response Trend를 확인하고 보고 workflow를 시작해야 하는 시점
tags:
- EventType
- DirectDevelopment
- SOP
...
boi_id: boi:public:event-types:direct_development.result_check.requested.v1
visibility: public
...
sop_stage_id: response_trend
workflow_stage: Response Trend 확인
recommended_actions:
...
`direct_development.result_check.requested.v1`는 [직개발 결과 확인 및 Reporting SOP](/public/sop/direct-development-reporting.md)의 `response_trend` stage를 실행하거나 사람이 판단해야 할 지점을 기록한다.

# Recommended Actions

- [Response Trend 확인 시뮬레이션](/public/actions/langflow/direct-development-quality-response-trend-simulate.md)
- [Map View 확인 이벤트 발행](/public/actions/event-broker/direct-development-create-map-view-event.md)
